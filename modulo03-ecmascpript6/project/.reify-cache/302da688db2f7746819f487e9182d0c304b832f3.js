...
describe('Terminal Controller', () => {
  ...
  it('should initialize terminal', () => {
    ...
    terminalController.initializeTerminal(LANGUAGE);

    expect(terminalController.initializeTable.calledOnce).to.be.ok;
    expect(terminalController.initializeTable.calledWith(LANGUAGE)).to.be.ok;
  ...
  it('should initialize table', () => {
    terminalController.initializeTable(LANGUAGE);
  ...
  it('should call terminal question', () => {
    terminalController.terminal = {
      question: (msg, resolve) => resolve(msg),
    };
    ...
    return terminalController.question(message).then(msg => {
      expect(terminalController.terminal.question.calledOnce).to.be.ok;
      expect(terminalController.terminal.question.calledWith(msg)).to.be.ok;
